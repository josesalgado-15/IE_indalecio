                                        ...
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            foreach ($arrInstitucion as $Institucion) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $Institucion->getNombre(); ?></td>
                                                    <td><?= $Institucion->getNit(); ?></td>
                                                    <td><?= $Institucion->getDireccion(); ?>, <?=  $Institucion->getMunicipio()->getNombre(); ?></td>
                                                    <td><?php echo $Institucion->getRector()->getNombres()," ", $Institucion->getRector()->getApellidos(),""; ?></td>
                                                    <td><?= $Institucion->getTelefono(); ?></td>
                                                    <td><?= $Institucion->getCorreo(); ?></td>
                                                    <td><?= $Institucion->getEstado(); ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($Institucion->getEstado() != "Activo") { ?>
                                                            <a href="../../../app/Controllers/MainController.php?controller=<?= $nameModel ?>&action=activate&id=<?= $Institucion->getId(); ?>"
                                                               type="button" data-toggle="tooltip" title="Activar"
                                                               class="btn docs-tooltip btn-success btn-xs"><i
                                                                        class="fa fa-check-square"></i></a>
                                                        <?php } else { ?>
                                                            <a type="button"
                                                               href="../../../app/Controllers/MainController.php?controller=<?= $nameModel ?>&action=inactivate&id=<?= $Institucion->getId(); ?>"
