...
<html>
<head>
    <title> Editar Matrícula | <?= $_ENV['TITLE_SITE'] ?></title>
                                ...
                                if (!empty($DataMatricula)) {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="post" id="frmEdit<?= $nameModel ?>"
                                            ...
                                            <input id="id" name="id" value="<?= $DataMatricula->getId(); ?>" hidden
                                                   required="required" type="text">

                                            <div class="form-group row">
                                                <label for="vigencia" class="col-sm-2 col-form-label">Vigencia</label>
                                                <div class="col-sm-10">
                                                    <input required type="date" value="<?= $DataMatricula->getVigencia()->toDateString(); ?>" class="form-control" id="vigencia"
                                                           name="vigencia" placeholder="Ingrese la vigencia">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <?= CursoController::selectCurso(
                                                        array(
                                                            'id' => 'cursos_id',
                                                            'name' => 'cursos_id',
                                                            'defaultValue' => (!empty($DataMatricula)) ? $DataMatricula->getCurso()->getId() : '',
                                                            'class' => 'form-control select2bs4 select2-info',
                                                            'where' => "estado = 'Activo'"
                                                        )
                                                    );
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="estado" name="estado" class="custom-select">
                                                        <option <?= ($DataMatricula->getEstado() == "Activo") ? "selected" : ""; ?> value="Activo">Activo</option>
                                                        <option <?= ($DataMatricula->getEstado() == "Inactivo") ? "selected" : ""; ?> value="Inactivo">Inactivo</option>
